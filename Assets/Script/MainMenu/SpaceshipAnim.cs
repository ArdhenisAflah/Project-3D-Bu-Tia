...
public class SpaceshipAnim : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Pitch: hidung naik turun sedikit, ikuti hover tapi agak telat
        float pitch = Mathf.Sin(_time * pitchSpeed + pitchPhase) * pitchAmplitude;

        // Yaw: berbelok pelan ke kiri-kanan
        float yaw = Mathf.Sin(_time * yawSpeed + yawPhase) * yawAmplitude;
